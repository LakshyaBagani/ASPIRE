    ...
    <div className="text-white min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 overflow-hidden">
      <nav
        ...
        style={{
          ...
          boxShadow:
            scrollY > 100 ? "0 4px 30px rgba(79, 70, 229, 0.15)" : "none",
        }}
      >
        ...
        <div className="flex space-x-8 items-center">
          <a href="#" className="hover:text-blue-400 transition-all text-xl">
            Service
          </a>
          <a href="#" className="hover:text-blue-400 transition-all text-xl">
            AI
            ...
            {[...Array(6)].map((_, i) => (
              <div
                ...
                style={{
                  ...
                  left: "calc(50% - 6px)",
                  top: "calc(50% - 6px)",
                  animation: `orbitDot ${10 + (i % 3) * 5}s linear infinite ${
                    i * 0.5
                  }s`,
          ...
          {[
            {
              title: "AI Strategy",
              icon: "🧠",
              desc: "Custom AI solutions tailored to your business needs",
            },
            {
              title: "Marketing",
              icon: "📈",
              desc: "Data-driven campaigns that deliver results",
            },
            {
              title: "Growth",
              icon: "🚀",
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-purple-300">
                  {card.title}
                </h3>
