...
import { TickCircleIcon } from "../FUNCTION/SVG";

function ADCampaign() {
  return (
    <div className="mb-15 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 p-8 rounded-xl border border-indigo-500/30 shadow-lg shadow-indigo-500/10 grid grid-cols-1 md:grid-cols-2 gap-10 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-gray-300 mb-8">
          Our AI-powered platform analyzes audience behavior, market trends, and
          competitor strategies to create hyper-targeted campaigns that deliver
          exceptional ROI.
        </p>
        <div className="space-y-6">
          <div className="group flex items-center gap-3">
            <TickCircleIcon className="flex-shrink-0" />
            <div className="flex-1">
              ...
              <p className="text-gray-400 mt-2">
                Precision targeting based on demographic, psychographic, and
                behavioral data.
              </p>
            </div>
          </div>
          <div className="group flex items-center gap-3">
            <TickCircleIcon className="flex-shrink-0" />
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-indigo-300 group-hover:text-transparent group-hover:bg-clip-t ext group-hover:bg-gradient-to-r group-hover:from-indigo-400 group-hover:to-cyan-400 transition-colors duration-300">
                Real-time Bidding Optimization
              </h3>
              <p className="text-gray-400 mt-2">
                Dynamic bid adjustments that maximize ad spend efficiency across
                platforms.
              </p>
            </div>
          </div>
          <div className="group flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-400 mt-2">
                Automated testing of ad elements to identify highest-performing
                combinations.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="bg-slate-800/50 rounded-lg p-6 border border-indigo-500/20 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300">
            <div className="flex justify-between items-center mb-3">
              ...
              <h3 className="text-xl font-bold text-indigo-400">+145%</h3>
            </div>
          ...
          <div className="bg-slate-800/50 rounded-lg p-6 border border-indigo-500/20 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300">
            <div className="flex justify-between items-center mb-3">
              ...
              <h3 className="text-xl font-bold text-indigo-400">+90%</h3>
            </div>
            <div className="w-full h-2 bg-slate-700 rounded-full overflow-hidden">
          ...
          <div className="bg-slate-800/50 rounded-lg p-6 border border-indigo-500/20 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300">
            <div className="flex justify-between items-center mb-3">
              ...
              <h3 className="text-xl font-bold text-indigo-400">+225%</h3>
            </div>
            <div className="w-full h-2 bg-slate-700 rounded-full overflow-hidden">
