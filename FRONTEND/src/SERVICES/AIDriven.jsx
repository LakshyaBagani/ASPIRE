...
import { BarGraphIcon, LightningIcon, TvIcon } from "../FUNCTION/SVG";
    ...
    <div className="mb-15 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 p-8 rounded-xl border border-indigo-500/30 shadow-lg shadow-indigo-500/10 grid grid-cols-1 md:grid-cols-2 gap-10 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-gray-300 mb-8">
          Leverage the power of artificial intelligence to transform your data
        ...
        <div className="space-y-6">
          <div className="group flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-2">
                Uncover customer preferences, intent, and journey patterns to
          ...
          <div className="group flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-2">
                Advanced modeling techniques that predict sales trends with up
                to 94% accuracy.
              </p>
            </div>
          </div>
          <div className="group flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-2">
                Identify processes that can be streamlined through AI-driven
      ...
      <div className="relative z-10">
        ...
        <div className="bg-slate-800/50 rounded-lg p-4 border border-indigo-500/20 shadow-md mb-6">
          <div className="aspect-video bg-gradient-to-br from-slate-900 to-indigo-900/40 rounded-md flex items-center justify-center overflow-hidden">
            <div className="text-indigo-300 p-4 text-center">
              ...
              <p className="text-sm">Interactive dashboard visualization</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-slate-800/50 rounded-lg p-6 border border-indigo-500/20 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300 text-center">
            <h2 className="text-3xl font-bold text-indigo-400 mb-2">+42%</h2>
          ...
          <div className="bg-slate-800/50 rounded-lg p-6 border border-indigo-500/20 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300 text-center">
            <h2 className="text-3xl font-bold text-cyan-400 mb-2">-28%</h2>
            <h3 className="text-lg font-medium text-gray-300">
